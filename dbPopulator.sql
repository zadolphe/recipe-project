...
insert into recipe (idRecipe, name,  difficulty, dateCreated, servingSize, prepTime, cookTime, userIDref) values (1, 'Apple Pie', 3, '2022-01-01' , 4, 0.45, 1.50, 1), (2, 'Pear Cobbler', 2, '2022-02-08', 4, 0.30, 0.15, 2), (17, 'Twenty-Four Hour Salad', 1, '2022-02-11', 6, 0.30, 24.00, 1), (18, 'Apple', 5, '2022-02-18', 1, 0.01, 0.10, 4), (19, 'Red Lentil Curry', 3, '2022-03-09', 3, 0.30, 0.30, 6), (20, 'Toasted Marhsmallow', 5, '2022-03-09', 1, 0.01, 0.05, 6);
...
insert into recipe_description (recipeIDref, wordCount, textBody) values (1, 11, 'Put the apple, sugar, flour, and butter into pan and cook.'),
                                                                         ...
                                                                         (19, 30, 'Heat 3T oil in saucepan. Add 2t spices. Stir in 2c lentils. Add 4c boiling water. Simmer for 10 minutes. Stir in 1c coconut milk. Add robo-pinch of salt. Serve.'),
                                                                         (20, 99, 'Very carefully slide marshmallow onto sufficiently pointy object - humans I have seen (of which I am one) use two-pronged, metal skewers as their stabbing implements. Then, proceed to slowly introduce stabbed marshmallow into nearby, open flame, provided that said flame does not exceed 900 degrees Celsius. Then, as the outer layer of your mashmallow begins to darken, begin rotating the marshmallow to create even (brownian) colouration. Upon a full coat of sufficient darkening having been acheived, remove marshmallow from stick and then consume if sufficiently cooled in temperature. Note that it appears some fellow meatbags enjoy this meal with chocolate and graham wafers.');
...
insert into recipe_uses_ingredient (ingredientNameref, ingredientBrandref,  recipeIDref) values ('apple', 'orgfarm', 1), 
                                                                                                ...
                                                                                                ('salt', 'quaker', 19),
                                                                                                ('marshmallow', 'fields', 20);

insert into user_favorites_recipe (userIDref, recipeIDref) values (1, 2), (3, 17), (4, 17), (4, 1), (3, 2); -- ENSURE UNIQUE;
insert into review (idReview, userIDref, recipeIDref, reviewText, dateUploaded, rating) values (null, 5, 18, 'This is the most low-effort post I have ever seen... disgraceful!', '2022-02-22', 1),
																							   (null, 4, 17, 'Nice recipe, yo!', '2022-04-04', 5),
                                                                                               (null, 4, 1, 'Dis pie is bomb!', '2022-04-02', 5),
                                                                                               (null, 3, 19, 'Ahhhhhhh... simply delectable! Never before have my taste buds chanced upon such a glorious dish - Bravo!!', '2022-03-15', 5),
                                                                                               (null, 3, 2, 'Positively wonderful! Dare I say, a must-try for any tired homebody!', '2022-04-02', 4),
                                                                                               (null, 2, 2, 'Clearly this must be the most good-looking author of all time who made this recipe.', '2022-02-09', 5),
                                                                                               (null, 2, 18, 'I agree! Incredible though apples might be, this recipe is hardly a recipe at all!!', '2022-02-23', 1),
                                                                                               (null, 6, 18, 'My sprockets are buzzing with excitement.', '2022-02-26', 5); -- ENSURE UNIQUE;
